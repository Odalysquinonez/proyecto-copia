...
class Docente(Persona):
    ...
    def __init__(self, cedula: str = None, nombre: str = None, apellido: str = None, email: str = None,
                 ...
                 , numero_libros: int = 0, activo: bool = True, carrera: str = None, titulo_3er_nivel: str = None,
                 titulo_4to_nivel: str = None):
        ...
        super(Docente, self).__init__(cedula=cedula, nombre=nombre, apellido=apellido, email=email, telefono=telefono,
